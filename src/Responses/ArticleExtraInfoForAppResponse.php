...
use ShopModule\WeclappApi\Models\ArticleExtraInfoForApp;

class ArticleExtraInfoForAppResponse extends SeveralResponse
{
    public function getModelBinding(): string
    {
        return ArticleExtraInfoForApp::class;
    }
}